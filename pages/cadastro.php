          ...
          <div class="row g-3">
            ...
            <div class="col-sm-3">
              ...
              <input type="tel" class="form-control" id="ddd" name="ddd" required
                pattern="\([0-9]{2}\)$" title="Digite o DDD no formato (DD)" placeholder="Ex: (17)" maxlength="4">
            ...
            <div class="col-sm-9">
              ...
              <input type="tel" class="form-control" id="telefone" name="telefone" required
                pattern="[0-9]{4,6}-[0-9]{3,4}$" title="Digite o telefone no formato XXXXX-XXXX" placeholder="Ex: 99999-9999"  maxlength="10">
              <div class="invalid-feedback">
                Valid last name is required.
              </div>
            </div>
