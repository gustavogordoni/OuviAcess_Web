  ...
  <div class="py-5 text-center">
    ...
    <div class="row">
      <div class="col-9 mx-auto">
        ...
        <form class="needs-validation" novalidate="" action="add_cadastro.php" method="POST">
          <div class="row g-3">

            <div class="col-sm-12">
              <label for="nome" class="form-label"><strong>Nome completo: </strong></label>
              <input type="text" class="form-control" id="nome" placeholder="Ex: Carlos Alberto" required name="nome">
            ...
            <div class="col-sm-3">
              ...
              <input type="text" class="form-control" id="ddd" placeholder="Ex: 17" name="ddd" required>
              <div class="invalid-feedback">
            ...
            <div class="col-sm-9">
              ...
              <input type="text" class="form-control" id="telefone" name="telefone"  placeholder="Ex: 99999-9999" required>
              <div class="invalid-feedback">
                Valid last name is required.
              </div>
            </div>
