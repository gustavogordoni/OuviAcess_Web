    ...
    <div class="container d-flex text-center" bis_skin_checked="1">
        ...
        <div class="col-md-4 m-2" bis_skin_checked="1">
            <div class="feature" bis_skin_checked="1"> <i class="feature-icon fi-yel"><img src="" alt=""></i>
                <h2 class="feature-title">Lorem ipsum</h2>
                    <p>
                        OLorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas vitae aliquam leo, vitae pellentesque risus. Aenean ac ante pellentesque, pulvinar ex eget, congue tellus. Aenean tincidunt molestie consequat. In faucibus neque turpis, eu porttitor purus sagittis ac.
                    </p>
            </div>
        </div>
    </div>
