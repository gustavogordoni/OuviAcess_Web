    ...
    if($cont == 0){
        ...
        <div class="d-flex h-75 text-center cor_tema">
            <div class="d-block my-auto mx-auto">
                ...
                <br><br>
                <a href="requerimento.php" class="btn btn-outline-info mt-5">Realize agora!</a>
            </div>
        </div>  
        <?php
    exit;
            ...
            <tbody class="text-center">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button class="btn btn-outline-primary my-auto mx-1 rounded-circle p-2" type="submit" value="<?= $row["id_requerimento"] ?>" name="id">
