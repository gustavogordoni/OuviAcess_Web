        ...
        <form class="needs-validation" action="add_requerimento.php" method="POST" enctype="multipart/form-data">
          <div class="row g-3">
            ...
            <div class="col-md-4">
              ...
              <input type="text" class="form-control" id="cep" name="cep" required title="Digite o CEP no formato XX.XXX-XXX" 
                placeholder="XX.XXX-XXX" pattern="\d{2}\.\d{3}-\d{3}">
              <div class="invalid-feedback">
            ...
            <div class="col-12">
              ...
              <textarea class="form-control" placeholder="Insira uma descrição detalhada sobre o ambiente em discussão" id="descricao" style="height: 100px" name="descricao" required 
                max="1000"></textarea>
              <div class="invalid-feedback">
