<?php
    ...
    <form>
        <h3 class="a_nav">Login</h3> 

        <label for="username" class="a_nav">Usuário</label>
        <input type="text" placeholder="Insira seu Email" id="username">

        <label for="password" class="a_nav">Senha</label>
