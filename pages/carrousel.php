        ...
        <div class="container">
          ...
          <div class="d-inline-block px-5 py-1 bg-dark bg-opacity-50 rounded-pill border border-info border-2">  
            <h2 class="fs-2 sombreado"><strong>Juntos somos mais!</strong></h2>
                ...
                <p class="text-light"><a class="btn btn-lg btn-primary" href="requerimento.php">Sugira!</a></p>
          </div>
          </div>
        </div>
      </div>
        ...
        <div class="container">
          ...
          <div class="d-inline-block px-5 py-1 bg-dark bg-opacity-50 rounded-pill border border-info border-2">  
            <h2 class="fs-2 sombreado"><strong>Seja bem-vindo(a) ao<br>OuviAcess!</strong></h2>
                ...
                <p class="text-light"><a class="btn btn-lg btn-primary" href="#sobre">Saiba mais</a></p>
          </div>
          </div>
        </div>
      </div>
        ...
        <div class="container">
          ...
          <div class="d-inline-block px-5 py-1 bg-dark bg-opacity-50 rounded-pill border border-info border-2">  
            <h2 class="fs-2 sombreado"><strong>Queremos te ouvir!</strong></h2>
                ...
                <p class="text-light"><a class="btn btn-lg btn-primary" href="requerimento.php">Denuncie!</a></p>
          </div>
          </div>
        </div>
      </div>
