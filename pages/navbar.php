    ...
    <div class="offcanvas offcanvas-start text-bg-<?= $tema ?>" tabindex="-1" id="offcanvasNavbar2" aria-labelledby="offcanvasNavbar2Label">
      ...
      <div class="offcanvas-body">
        ...
        <div class="d-flex my-auto justify-content-evenly">
          ...
          ?>
            <a href="login.php"><button type="button" class="btn btn-outline-primary mx-1 rounded-pill">Login</button></a>
            <a href="cadastro.php"><button type="button" class="btn btn-outline-danger mx-1 rounded-pill">Cadastre-se</button></a>
          <?php
          } else {
          ?>
            <a href="logout.php" type="button" class="btn btn-primary mx-1 rounded-circle p-2 my-auto">
            ...
            <a href="logout.php" type="button" class="btn btn-danger mx-1 rounded-circle p-2 my-auto">
