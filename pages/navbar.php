      ...
      <div class="offcanvas-body">
        <ul class="navbar-nav justify-content-center flex-grow-1 nav-pills">
          ...
          <li class="nav-item mx-2">
            <a href="../." class="nav-link<?= ativar('inicio.php') ?> text-center">
          ...
          <li class="nav-item mx-2">
            <a href="historico.php" class="nav-link<?= ativar('historico.php') ?> <?= ativar('visualizar-requerimento.php') ?> <?= ativar('editar-requerimento.php') ?> <?= ativar('excluir-requerimento.php') ?> text-center">
              <svg xmlns="http://www.w3.org/2000/svg" class="bi d-block mx-auto mb-1" width="15" height="15" fill="currentColor" viewBox="0 0 16 16">
          ...
          <?php
          if (basename($_SERVER["PHP_SELF"]) == "visualizar-requerimento.php") {
          ?>
          ...
          ?>
          <?php
          if (basename($_SERVER["PHP_SELF"]) == "editar-requerimento.php") {
          ?>
        ...
        <div class="d-flex my-auto justify-content-evenly">
          ...
          ?>
            ...
            <?php
            if (basename($_SERVER["PHP_SELF"]) == "cadastro-usuario.php") {
              $btn_cadastro = "btn-danger";
            } elseif (basename($_SERVER["PHP_SELF"]) != "cadastro-usuario.php") {
              $btn_cadastro = "btn-outline-danger";
            } ?>
            <a href="cadastro-usuario.php"><button type="button" class="btn  <?= $btn_cadastro ?> mx-1 rounded-pill">
          ...
          ?>
            <a href="perfil.php"><button type="button" class="btn <?= $btn_perfil ?> mx-1 rounded-pill">
            ...
            <a href="logout.php"><button type="button" class="btn btn-outline-danger mx-1 rounded-pill">
