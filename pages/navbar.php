      ...
      <div class="offcanvas-body">
        ...
        <div class="d-flex my-auto justify-content-evenly">
          ...
          ?>
            ...
            <a href="cadastro.php"><button type="button" class="btn btn-outline-danger mx-1 rounded-pill">
          ...
          ?>
            <a href="perfil.php"><button type="button" class="btn btn-outline-primary mx-1 rounded-pill">
