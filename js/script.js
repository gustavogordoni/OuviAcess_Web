document.addEventListener("DOMContentLoaded", function() {
  ...
  confirmeInput.addEventListener("input", () => {
      if (senhaInput.value !== confirmeInput.value) {
          confirmeInput.setCustomValidity("As senhas não coincidem.");
      } else {
          confirmeInput.setCustomValidity("");
      }
  });

  senhaInput.addEventListener("input", () => {
      confirmeInput.dispatchEvent(new Event("input"));
  });
});
